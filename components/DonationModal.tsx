  ...
  const handlePayment = (e: React.FormEvent) => {
    ...
    if (window.CinetPay) {
        window.CinetPay.setConfig({
            ...
            mode: 'PRODUCTION', // Mettre 'PRODUCTION' pour les vrais paiements
        });

        // 2. Lancement du Checkout
        window.CinetPay.getCheckout({
            transaction_id: transactionId,
            amount: amount,
            currency: 'XOF',
            channels: 'ALL', // Laisse CinetPay afficher Wave, OM, MTN etc.
            ...
            customer_surname: '',
            customer_email: '', // Peut être ajouté au formulaire
        ...
        // Fallback si le script n'est pas chargé (ex: hors ligne)
