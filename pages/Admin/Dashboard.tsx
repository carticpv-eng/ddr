  ...
  return (
    <div className="space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Chart Section */}
          <div className="lg:col-span-2 bg-[#121214] p-6 rounded-xl border border-gray-800 shadow-sm flex flex-col">
             <div className="flex justify-between items-center mb-6">
                 <div>
                    <h2 className="text-lg font-bold text-white">Flux des Dons</h2>
                    <p className="text-xs text-gray-500">Entrées financières sur 30 jours</p>
                 </div>
                 <div className="flex bg-black rounded-lg p-1 border border-gray-800">
                     <button className="px-3 py-1 text-xs font-bold text-white bg-gray-800 rounded">Mois</button>
                     <button className="px-3 py-1 text-xs font-bold text-gray-500 hover:text-white">Année</button>
                 </div>
             </div>
             
             <div className="h-72 w-full relative flex-grow bg-black/20 rounded-lg border border-gray-800/50 p-4">
                 {/* CSS/SVG Chart */}
                 <svg className="w-full h-full overflow-visible" viewBox="0 0 100 50" preserveAspectRatio="none">
                     ...
                     <line x1="0" y1="40" x2="100" y2="40" stroke="#333" strokeWidth="0.2" strokeDasharray="2" />
                     <line x1="0" y1="25" x2="100" y2="25" stroke="#333" strokeWidth="0.2" strokeDasharray="2" />
                     <line x1="0" y1="10" x2="100" y2="10" stroke="#333" strokeWidth="0.2" strokeDasharray="2" />

                     <path d="M0,45 L10,38 L20,40 L30,28 L40,32 L50,18 L60,22 L70,8 L80,12 L90,5 L100,2 L100,50 L0,50 Z" fill="url(#gradient)" />
                     <path d="M0,45 L10,38 L20,40 L30,28 L40,32 L50,18 L60,22 L70,8 L80,12 L90,5 L100,2" fill="none" stroke="#ea580c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />
                     
                     {/* Highlights */}
                     <circle cx="70" cy="8" r="1.5" fill="#fff" stroke="#ea580c" strokeWidth="0.5" />
                     <circle cx="90" cy="5" r="1.5" fill="#fff" stroke="#ea580c" strokeWidth="0.5" />
                 </svg>
                 <div className="flex justify-between text-[10px] text-gray-600 uppercase tracking-wider mt-4 font-mono">
                     <span>1 Nov</span>
                     <span>8 Nov</span>
                     <span>15 Nov</span>
                     <span>22 Nov</span>
          ...
          <div className="bg-[#121214] p-0 rounded-xl border border-gray-800 shadow-sm flex flex-col overflow-hidden">
             ...
             <div className="p-6 pt-0 flex-1 flex flex-col">
                 ...
                 <button className="mt-6 w-full py-3 bg-white text-black hover:bg-gray-200 text-xs font-bold uppercase tracking-wider rounded-lg transition">
                     Gérer le chantier
                 </button>
             </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           ...
           <div className="lg:col-span-2 bg-[#121214] rounded-xl border border-gray-800 overflow-hidden shadow-sm">
                <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-black/20">
                    ...
                    <button className="text-xs text-brand-500 hover:text-brand-400 font-bold border border-brand-500/30 px-3 py-1 rounded-full">Voir tout</button>
                </div>
           ...
           <div className="space-y-6">
                ...
                <div className="bg-[#121214] p-6 rounded-xl border border-gray-800">
                    ...
                    <div className="space-y-3">
                        <button className="w-full text-left px-4 py-3 bg-black hover:bg-gray-900 rounded-lg border border-gray-800 hover:border-brand-500/50 text-sm text-gray-300 transition flex items-center gap-3 group">
